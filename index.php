...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@facturacionweb.site">info@hotelarias.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+0987116535</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HOTEL<span>ARIAS</span><p class="logo_w3l_agile_caption">Tu resort de ensueño</p></a></h1>
				</div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  ...
  <span>SUBIR</span></h4>
										...
										<p>Ofrecemos a los clientes las mejore habitaciones.</p>
									</div>
								</div>
							</div>
						</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls"> Somos un hotel , que quiere brindarte las mejores opciones de hospedaje</p>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Equipo</h3>
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Esfuerzo , dedicacion y trabajo duro para sacar adelante todos los proyectos
.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Trabajamos para brindarte la mejor estadia .</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Porque siempre pensamos primero en nuestros clientes mezclamos comodidad con un precio economico.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
...
:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Teléfono :</strong>+0987116535</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:info@facturacionweb.site">info@hotelarias.com</a></p>
			<p class="contact-agile1"><strong>Direccion :</strong> Quito, Ecuador</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.794615512702!2d-78.49822365033475!3d-0.19750573546081082!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91d59a6a396e7a79%3A0xb00ae5ab53467167!2sInstituto%20Tecnol%C3%B3gico%20Quito!5e0!3m2!1ses-419!2sec!4v1591312942248!5m2!1ses-419!2sec" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2020  <a href="index.php">HOTEL ARIAS BY RICARDO PATIÑO ARIAS</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
